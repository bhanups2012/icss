...
public class SurchargeRateControllerAddRate extends RateAndSurchargeAbstract {
    ...
    public void givenValidRate_thenStatus200_WithRateResponse() throws Exception {
        MockHttpServletRequestBuilder mockRequest = MockMvcRequestBuilders.post("/rms/addRate")
